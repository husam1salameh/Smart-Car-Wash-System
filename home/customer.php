...
<div class="title">حسابات الزبائن</div>
<script>
...
<a href="customer_edit.php?action=insert_data" >
	<div align="right" class="btn btn-success" style="float:right;color:white;font-size:1.0em;margin:5px;height:25px;padding:2px;width:120px;">
		<span style="float:right;margin-right:5px;" >اضافة زبون</span>
	</div>
</a>
...
<table class="table" width="100%" >
    ...
    <?php
		...
		$sql = "SELECT * FROM customer WHERE 1 AND delete_status=0 ORDER BY id DESC"; 
    ...
    while ($row = mysqli_fetch_array($query)) {
        ...
        <tr>
            ...
            <td><a title="تعديل معلومات الزبون" href="customer_edit.php?action=update_data&row_id=<?php echo $id; ?>"><img src="../assets/icons/update.png" width=22 /> </a></td>
            <td><a onclick="cancel_restore_row(this,'cancel_row',<?php echo $id; ?>)" title="حذف الزبون" ><img src="../assets/icons/delete.png" width=22 /></a></td>
